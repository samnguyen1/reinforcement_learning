...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str, default="HalfCheetah-v4", help="Environment ID (Gymnasium env name).")
    ...
    env_key = args.env.split('-')[0].lower()  # e.g., "HalfCheetah-v4" -> "halfcheetah"
